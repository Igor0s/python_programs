...
def choose_square(event):
    #function choose_square finds coordinates of square which user has clicked and stores them
    #in variables x1,y1, x2.y2
    global first_sq, second_sq, counter, x1, x2, y1, y2, score
...
def check_match():
    ...
    if first_sq == second_sq and (x1 != x2 or y1 != y2):
        score += 1
        canvas.delete('score')
